    ...
    return (
        <section className="w-full px-5 md:px-16 py-20 flex justify-around gap-5 bg-white">
            ...
            <div className="bg-primary-green flex flex-col gap-2 md:flex-row justify-between w-full rounded-lg p-4 md:p-16">
                ...
                <h2 className="text-base md:text-2xl text-white">Start Your Healthcare Journey Today</h2>
                <p   className=" text-white text-sm md:text-base w-full md:w-4/5">Join millions of patients who access quality care on their terms. Free to download.</p>
                </div>
