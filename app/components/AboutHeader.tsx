    ...
    return (
        <header className="relative md:px-16 overflow-clip about-body">
            <div className="absolute top-0 left-0 z-10 w-screen lg:w-475 h-182.5 bg-[#00000062]"/>
                ...
                <div className="w-full flex-col flex items-start gap-6 px-6 md:px-16 z-20 py-5">
                    ...
                    <p className="w-[90%] lg:w-[55%] text-left text-xs md:text-sm text-white leading-5 md:leading-6.5">We build the connective tissue between patients, providers, and healthcare systems — so that getting care feels less like navigating a labyrinth and more like talking to someone who actually knows you.</p>
